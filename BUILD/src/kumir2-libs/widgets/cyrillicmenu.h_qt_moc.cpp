...
const QMetaObject Widgets::CyrillicMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_Widgets__CyrillicMenu.data,
      qt_meta_data_Widgets__CyrillicMenu,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Widgets::CyrillicMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Widgets__CyrillicMenu.stringdata0))
        return static_cast<void*>(const_cast< CyrillicMenu*>(this));
