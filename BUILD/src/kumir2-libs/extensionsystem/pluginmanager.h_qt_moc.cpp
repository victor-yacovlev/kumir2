...
const QMetaObject ExtensionSystem::PluginManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExtensionSystem__PluginManager.data,
      qt_meta_data_ExtensionSystem__PluginManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
