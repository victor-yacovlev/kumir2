...
const QMetaObject ExtensionSystem::KPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExtensionSystem__KPlugin.data,
      qt_meta_data_ExtensionSystem__KPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ExtensionSystem::KPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ExtensionSystem__KPlugin.stringdata0))
        return static_cast<void*>(const_cast< KPlugin*>(this));
    if (!strcmp(_clname, "Shared::PluginInterface"))
        return static_cast< Shared::PluginInterface*>(const_cast< KPlugin*>(this));
