...
{
    llvm::Linker::LinkModules(dest.rawPtr(), rawPtr());
    d.reset(); // For LLVM 3.8+ compatible behaviour
}
                                              ...
                                              llvm::LLVMContext * ctx)
{
    ...
    llvm::MemoryBufferRef unitBufferRef = llvm::MemoryBufferRef(lContents, lFileName);
