...
{$endif PREPROCWRITE}
    procedure compile(const filename:string; const source: pchar);
...
{$ENDIF}
      ...
      cresstr,cpuinfo,procinfo,ipputils;
    ...
    procedure compile(const filename:string; const source: pchar);
      ...
      var
       ...
       { reset the unit or create a new program }
         ...
         if source<>nil then
         begin
              current_scanner.inputfile:=TInputBuffer.create(filename, source);
         end;
