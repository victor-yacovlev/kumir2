...
{$ENDIF POWERPC}
    ...
    procedure AddUnit(const s:string);
      ...
      begin
        ...
        if not showonlylocalsymbols then
        begin
            PrintSymbolTable(hp.globalsymtable, false);
        end;
...
{$endif arm}
    ...
    procedure proc_program(islibrary : boolean);
      ...
      begin
         ...
         if current_module.realmodulename^<>'' then
           begin
             writeln('unitname local ',current_module.realmodulename^);
           current_module.localsymtable.insert(tunitsym.create(current_module.realmodulename^,current_module));
           end;
         ...
         PrintSymbolTable(current_module.localsymtable, true);
         { save file pos for debuginfo }
