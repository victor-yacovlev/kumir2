...
isEmpty(ERRORMESSAGES_PRO) {
    contains(CONFIG,generate_messages) {
        ...
        pr.commands = python $${_PRO_FILE_PWD_}/../../shared/errormessages/scanmessages.py --db=$${IDE_SOURCE_TREE}/share/kumir2/$${TARGET}.messages.csv --out=$${IDE_DATA_PATH}/$${TARGET}.messages.csv $${_PRO_FILE_PWD_} $${EXTRA_MESSAGES_DIRS}
