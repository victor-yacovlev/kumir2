...
isEmpty(ERRORMESSAGES_PRO) {
    contains(CONFIG,generate_messages) {
        ...
        system(python $${_PRO_FILE_PWD_}/../../shared/errormessages/scanmessages.py --db=$${IDE_SOURCE_TREE}/share/kumir2/$${MSG_FILE} --out=$${IDE_DATA_PATH}/$${MSG_FILE} $${_PRO_FILE_PWD_} $${EXTRA_MESSAGES_DIRS})
    }
