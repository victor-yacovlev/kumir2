...
#ifndef GDBMI_BREAKPOINT_H
#define GDBMI_BREAKPOINT_H
...
inline uint qHash(const GdbMi::BreakpointModelId &id)
{
...
Q_DECLARE_METATYPE(GdbMi::BreakpointModelId)
Q_DECLARE_METATYPE(GdbMi::BreakpointResponseId)

#endif // GDBMI_BREAKPOINT_H
