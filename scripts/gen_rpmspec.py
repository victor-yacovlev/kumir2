...
def print_usage_and_exit(errcode):
    ...
    sys.stderr.write("   "+sys.argv[0]+" --packager=\"Your Name <your@e.mail>\" [--out=outfile] [--release=relno]\n")
    sys.exit(errcode)
...
if __name__=="__main__":
    ...
    out.write("\n# Do not edit!\n")
    out.write("# This file generated by \"scripts/gen_rpm.py\" and will be overwritten\n\n")
    out.write("Name:\tkumir2\n")
    out.write("Summary:\tKumir education system\n")
    out.write("License:\tGPL2+\n")
    ...
    out.write("BuildRequires:\t"+QT_DEV_LIB+" >= "+QT_MIN_VERSION+"\n")
    ...
    for name, item in proj.components.items():
        ...
        out.write("Group:\t"+GROUP+"\n")
        out.write("Requires:\t"+QT_LIB+" >= "+QT_MIN_VERSION+"\n")
        if item.isweb:
